...
Func Example()
	...
	_LOBase_FormCreate($oDoc, $oConnection, "AutoIt_Folder/frmAutoIt_Form3", False)
	If @error Then Return _ERROR($oDoc, "Failed to create a form Document. Error:" & @error & " Extended:" & @extended)
	...
	MsgBox($MB_OK, "", "Here is a list of forms contained in the document." & @CRLF & $sForms)

	$sForms = ""

	; Delete a form.
	_LOBase_FormDelete($oDoc, "frmAutoIt_Form")
	If @error Then Return _ERROR($oDoc, "Failed to delete a form. Error:" & @error & " Extended:" & @extended)
