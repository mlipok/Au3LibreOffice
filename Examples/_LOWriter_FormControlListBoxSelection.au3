...
Func Example()
	...
	_LOWriter_FormControlListBoxSelection($oControl, $aiSelection)
	...
	$aiCurSel = _LOWriter_FormControlListBoxSelection($oControl)
	...
	$asSel = _LOWriter_FormControlListBoxSelection($oControl, Null, True)
	If @error Then _ERROR($oDoc, "Failed to retrieve Control's current selection. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
