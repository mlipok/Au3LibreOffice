...
Func Example()
	...
	_LOBase_ReportDetail($oReportDoc, "AutoIt_Detail_Section", $LOB_REP_FORCE_PAGE_AFTER_SECTION, False, True, 4500, Null, $LOB_COLOR_TEAL)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Section's current settings are: " & @CRLF & _
			...
			"The Height of the section is, in Micrometers: " & $avReport[4] & @CRLF & _
