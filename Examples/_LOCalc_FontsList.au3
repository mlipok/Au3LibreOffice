...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Array of font names. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "There were " & @extended & " fonts found. I will now display the results in the Calc sheet. The Array will have four columns, " & @CRLF & _
...
If @error Then _ERROR($oDoc, "Failed to retrieve currently active sheet. Error:" & @error & " Extended:" & @extended)
