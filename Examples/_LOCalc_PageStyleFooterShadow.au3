...
Func Example()
	...
	; Set Page style Footer Shadow settings to: Width = 1/8", Color = $LO_COLOR_RED, Transparent = False, Location = $LOC_SHADOW_TOP_LEFT
	_LOCalc_PageStyleFooterShadow($oPageStyle, $iMicrometers, $LO_COLOR_RED, False, $LOC_SHADOW_TOP_LEFT)
