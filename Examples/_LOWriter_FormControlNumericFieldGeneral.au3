...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_NUMERIC_FIELD, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormControlNumericFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, False, True, True, False, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_ALWAYS, True, 1, 1.25, 50.00, 2, 18.44, 2, False, True, True, 50, $mFont, $LOW_ALIGN_HORI_CENTER, $LOW_ALIGN_VERT_BOTTOM, $LOW_COLOR_GOLD, $LOW_FORM_CONTROL_BORDER_3D, $LOW_COLOR_BLACK, False, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlNumericFieldGeneral($oControl)
