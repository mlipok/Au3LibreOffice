...
Func Example()
	...
	; Set Page style Footer Border Style settings to: Top = $LOC_BORDERSTYLE_DASH_DOT_DOT, Bottom = $LOC_BORDERSTYLE_THICKTHIN_MEDIUMGAP
	; Left = $LOC_BORDERSTYLE_DOUBLE, Right = $LOC_BORDERSTYLE_DASHED
	_LOCalc_PageStyleFooterBorderStyle($oPageStyle, $LOC_BORDERSTYLE_DASH_DOT_DOT, $LOC_BORDERSTYLE_THICKTHIN_MEDIUMGAP, $LOC_BORDERSTYLE_DOUBLE, $LOC_BORDERSTYLE_DASHED)
	If @error Then _ERROR($oDoc, "Failed to modify Page Style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
