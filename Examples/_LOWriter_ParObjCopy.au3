...
Func Example()
	...
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to retrieve the View Cursor Object for the Writer Document. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to insert text. Error:" & @error & " Extended:" & @extended)

	; Move the Cursor to the beginning of the document
	_LOWriter_CursorMove($oViewCursor, $LOW_VIEWCUR_GOTO_START, 1, False)
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to move the View Cursor. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to set Font Color. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to set underline settings. Error:" & @error & " Extended:" & @extended)

	; Create a list of Paragraph Objects
	$aoPars = _LOWriter_ParObjCreateList($oViewCursor)
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to retrieve array of paragraphs. Error:" & @error & " Extended:" & @extended)

	; Select the first Paragraph
	_LOWriter_ParObjSelect($oDoc, $aoPars[0])
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to select the paragraph. Error:" & @error & " Extended:" & @extended)

	; Copy the Paragraph.
	$oPar = _LOWriter_ParObjCopy($oDoc)
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to copy the paragraphs. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, $oDoc2, "Failed to paste the paragraph object. Error:" & @error & " Extended:" & @extended)
