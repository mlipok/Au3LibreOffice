...
Func Example()
	...
	MsgBox($MB_OK, "", "I will now highlight in yellow the cell ranges returned that contain Strings.")
	...
	MsgBox($MB_OK, "", "I will now highlight in Red the cell ranges returned that contain Numbers and Formulas.")
