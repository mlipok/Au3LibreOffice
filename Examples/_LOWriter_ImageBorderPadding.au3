...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to modify Image settings. Error:" & @error & " Extended:" & @extended)
	...
	MsgBox($MB_OK, "", "The Image's Border Padding Width settings are as follows: " & @CRLF & _
