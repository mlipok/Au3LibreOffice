...
Func Example()
	...
	$oControl = _LOWriter_FormConInsert($oForm, $LOW_FORM_CONTROL_TYPE_PATTERN_FIELD, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormConPatternFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, 75, "LLNNLNNLNN", "20__/__/__", True, True, True, False, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_DISABLED, True, 1, @YEAR & "/" & @MON & "/" & @MDAY, $mFont, $LOW_ALIGN_HORI_CENTER, $LOW_ALIGN_VERT_BOTTOM, $LOW_COLOR_GOLD, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_COLOR_YELLOW, False, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
