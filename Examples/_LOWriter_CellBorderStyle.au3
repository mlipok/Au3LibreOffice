...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell Border width settings. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell Border Style settings. Error:" & @error & " Extended:" & @extended)

	; Set Table Cell's Text.
	_LOWriter_CellString($oCell, "Text inside the Cell's styled borders.")
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell text. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Text Table cell Border Style settings. Error:" & @error & " Extended:" & @extended)
