...
Func Example()
	...
	MsgBox($MB_OK, "", "Does a Page Style Named ""NewPageStyle"" exist in the document? True/False: " & _
	...
	MsgBox($MB_OK, "", "Now does a Page Style Named ""NewPageStyle"" exist in the document? True/False: " & _
			_LOCalc_PageStyleExists($oDoc, "NewPageStyle"))
