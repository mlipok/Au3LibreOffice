...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve an array of Keys. Error:" & @error & " Extended:" & @extended)
	$iResults = @extended
	...
	For $i = 0 To $iResults - 1
		...
		If @error Then _ERROR($oDoc, "Failed to retrieve Cell Object by position. Error:" & @error & " Extended:" & @extended)
