...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to Rotate the Shape. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to Rotate the Shape and apply a slant. Error:" & @error & " Extended:" & @extended)
