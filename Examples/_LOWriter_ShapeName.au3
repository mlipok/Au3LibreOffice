...
Func Example()
	...
	If @error Then _ERROR("Failed to retrieve Shape name. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to modify Shape name. Error:" & @error & " Extended:" & @extended)
