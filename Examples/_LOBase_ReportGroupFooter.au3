...
Func Example()
	...
	_LOBase_ReportGroupFooter($oGroup, True, "AutoIt_Group", $LOB_REP_FORCE_PAGE_AFTER_SECTION, False, True, True, 2576, Null, $LOB_COLOR_BRICK)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Group's current settings are: " & @CRLF & _
			...
			"The Height of the Group Footer is, in Micrometers: " & $avGroup[6] & @CRLF & _
