...
Func Example()
	...
	; Set the underline settings to, Underline words only, Underline style $LOC_UNDERLINE_BOLD_DASH_DOT, has color = True, and underline color = Gold.
	_LOCalc_TextCursorUnderline($oTextCursor, True, $LOC_UNDERLINE_BOLD_DASH_DOT, True, $LOC_COLOR_GOLD)
