...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to modify the search descriptor. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve settings. Error:" & @error & " Extended:" & @extended)
