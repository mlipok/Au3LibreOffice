...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "I am going to demonstrate how to convert the Long color format integer value, $LOB_COLOR_MAGENTA (12517441), into R(ed), G(reen), " & _
	...
	$aiRGB = _LOBase_ConvertColorFromLong(Null, $LOB_COLOR_MAGENTA)
	...
	$sHex = _LOBase_ConvertColorFromLong($LOB_COLOR_MAGENTA)
	...
	$aiCMYK = _LOBase_ConvertColorFromLong(Null, Null, Null, $LOB_COLOR_MAGENTA)
	...
	$aiHSB = _LOBase_ConvertColorFromLong(Null, Null, $LOB_COLOR_MAGENTA)
