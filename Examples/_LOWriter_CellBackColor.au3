...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve current Text Table Cell Background settings. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to set Text Table Cell Background settings. Error:" & @error & " Extended:" & @extended)
