...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_LABEL, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormControlLabelGeneral($oControl, "Renamed_AutoIt_Control", "A Label's Label", Null, True, True, False, $mFont, $LOW_ALIGN_HORI_LEFT, $LOW_ALIGN_VERT_MIDDLE, $LOW_COLOR_BLUE, $LOW_FORM_CONTROL_BORDER_3D, $LOW_COLOR_GREEN, True, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlLabelGeneral($oControl)
