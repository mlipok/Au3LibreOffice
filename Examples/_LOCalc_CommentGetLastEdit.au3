...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve comment's Edit information. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "The Cell was created by: " & $asEdit[0] & @CRLF & _
