...
Func Example()
	...
	_LOWriter_PageStyleFooter($oPageStyle, True, False, True, $i100thMM, $i100thMM, $i100thMM2, False, Null, True)
	If @error Then _ERROR($oDoc, "Failed to modify Page Style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Page Style's current Footer settings are as follows: " & @CRLF & _
			...
			"The Left Margin Width is, in Hundredths of a Millimeter (100th MM): " & $avPageStyleSettings[3] & @CRLF & _
			"The Right Margin Width is, in Hundredths of a Millimeter (100th MM): " & $avPageStyleSettings[4] & @CRLF & _
			"The Spacing between the Footer contents and the Page contents, in Hundredths of a Millimeter (100th MM): " & $avPageStyleSettings[5] & @CRLF & _
			...
			"The height of the Footer, in Hundredths of a Millimeter (100th MM): " & $avPageStyleSettings[7] & @CRLF & _
