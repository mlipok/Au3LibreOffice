...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Frame Fill Style. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "The Frame Style's current Fill Style is: " & $iFillStyle & @CRLF & _
