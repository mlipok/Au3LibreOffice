...
Func Example()
	...
	_LOWriter_PageStyleBorderPadding($oPageStyle, $i100thMM, Null, $i100thMM2)
	If @error Then _ERROR($oDoc, "Failed to modify Page Style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Page Style's current Border Padding Width settings are as follows: " & @CRLF & _
			"The ""All"" Border Padding Width is, in Hundredths of a Millimeter (100th MM), (see UDF constants): " & $avPageStyleSettings[0] & @CRLF & _
			"The Top Border Padding Width is, in Hundredths of a Millimeter (100th MM), (see UDF constants): " & $avPageStyleSettings[1] & @CRLF & _
			"The Bottom Border Padding Width is, in Hundredths of a Millimeter (100th MM), (see UDF constants): " & $avPageStyleSettings[2] & @CRLF & _
			"The Left Border Padding Width is, in Hundredths of a Millimeter (100th MM), (see UDF constants): " & $avPageStyleSettings[3] & @CRLF & _
			"The Right Border Padding Width is, in Hundredths of a Millimeter (100th MM), (see UDF constants): " & $avPageStyleSettings[4])
