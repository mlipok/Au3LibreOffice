...
Func Example()
	...
	$i100thMM1 = _LO_UnitConvert(2.5, $LO_CONVERT_UNIT_INCH_100THMM)
	...
	_LOCalc_CommentSize($oComment, $i100thMM1, $i100thMM2, True)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Comment's Size settings are as follows: " & @CRLF & _
			"The Width of the Comment box is, in Hundredths of a Millimeter (100th MM): " & $avSettings[0] & @CRLF & _
			"The Height of the comment box is, in Hundredths of a Millimeter (100th MM): " & $avSettings[1] & @CRLF & _
