...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Frame style's size settings are as follows: " & @CRLF & _
			"The Frame style width is, in Hundredths of a Millimeter (100th MM): " & $avSettings[0] & @CRLF & _
			...
			"The Frame style height is, in Hundredths of a Millimeter (100th MM): " & $avSettings[4] & @CRLF & _
