...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to delete field. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Page Style name. Error:" & @error & " Extended:" & @extended)

	; Retrieve the Page Style object.
	$oPageStyle = _LOCalc_PageStyleGetObj($oDoc, $sPageStyle)
	If @error Then _ERROR($oDoc, "Failed to retrieve Page Style object by name. Error:" & @error & " Extended:" & @extended)

	; Retrieve the Header Object
	$oHeader = _LOCalc_PageStyleHeaderObj($oPageStyle, Default)
	If @error Then _ERROR($oDoc, "Failed to retrieve Page Style header object. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to create Text Cursor in header. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve array of fields in header. Error:" & @error & " Extended:" & @extended)
