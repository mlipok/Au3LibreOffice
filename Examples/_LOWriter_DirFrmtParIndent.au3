...
Func Example()
	...
	_LOWriter_DirFrmtParIndent($oViewCursor, $i100thMM, $i100thMM2, $i100thMM3, False)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The current Paragraph Indent settings are as follows: " & @CRLF & _
			"Indent spacing before the paragraph, in Hundredths of a Millimeter (100th MM): " & $avSettings[0] & @CRLF & _
			"Spacing after the paragraph, in Hundredths of a Millimeter (100th MM): " & $avSettings[1] & @CRLF & _
			"First line Indent spacing, in Hundredths of a Millimeter (100th MM): " & $avSettings[2] & @CRLF & _
