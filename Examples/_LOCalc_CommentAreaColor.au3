...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve comment Area Color. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "The Comment's current background color is, in Long Color format: " & $iColor)
