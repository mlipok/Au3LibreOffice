...
Func Example()
	...
	$oControl = _LOWriter_FormConInsert($oForm, $LOW_FORM_CONTROL_TYPE_FORMATTED_FIELD, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormConFormattedFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, 20, True, True, False, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_DISABLED, True, 1, 29.50, 70.25, 35.50, $iFormat, True, True, 100, $mFont, $LOW_ALIGN_HORI_LEFT, $LOW_ALIGN_VERT_BOTTOM, $LOW_COLOR_GRAY, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_COLOR_GREEN, False, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
