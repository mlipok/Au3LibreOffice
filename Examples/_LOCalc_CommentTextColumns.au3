...
Func Example()
	...
	; Modify the Comment's Column settings to: Use 3 Columns, and set a spacing of 280 Hundredths of a Millimeter (100th MM).
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Comment's Column settings are as follows: " & @CRLF & _
			...
			"The Spacing between the Columns is, in Hundredths of a Millimeter (100th MM): " & $avSettings[1])
