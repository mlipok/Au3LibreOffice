...
Func Example()
	...
	; Modify the Comment Line Style settings to: Set the line style to $LOC_COMMENT_LINE_STYLE_DASH_DOT_ROUNDED, Line color = $LO_COLOR_INDIGO, Line width = 80 Hundredths of a Millimeter (100th MM)
