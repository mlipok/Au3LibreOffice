...
Func Example()
	...
	_LOWriter_FormConCurrencyFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, True, True, True, True, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_FOCUS, True, 1, _
