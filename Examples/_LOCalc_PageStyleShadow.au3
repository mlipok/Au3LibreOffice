...
Func Example()
	...
	; Set Page style Shadow settings to: Width = 1/8", Color = $LO_COLOR_RED, Transparent = False, Location = $LOC_SHADOW_TOP_LEFT
	_LOCalc_PageStyleShadow($oPageStyle, $iMicrometers, $LO_COLOR_RED, False, $LOC_SHADOW_TOP_LEFT)
