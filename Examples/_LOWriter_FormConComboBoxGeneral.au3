...
Func Example()
	...
	$oControl = _LOWriter_FormConInsert($oForm, $LOW_FORM_CONTROL_TYPE_COMBO_BOX, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormConComboBoxGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, 35, True, True, False, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_FOCUS, True, _
