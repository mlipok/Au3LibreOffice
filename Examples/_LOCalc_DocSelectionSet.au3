...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to select Cell Range. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to select Cell. Error:" & @error & " Extended:" & @extended)
