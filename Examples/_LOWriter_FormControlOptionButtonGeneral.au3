...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_OPTION_BUTTON, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	$oGroupBox = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_GROUP_BOX, 2000, 2300, 6000, 2000, "AutoIt_Form_Control2")
	If @error Then _ERROR($oDoc, "Failed to insert a form control. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Create a Font Descriptor.
	$mFont = _LOWriter_FontDescCreate($oDoc, "Times New Roman", $LOW_WEIGHT_BOLD, $LOW_POSTURE_ITALIC, 16, $LOW_COLOR_INDIGO, $LOW_UNDERLINE_BOLD, $LOW_COLOR_GREEN, $LOW_STRIKEOUT_NONE, False, $LOW_RELIEF_NONE)
	...
	_LOWriter_FormControlOptionButtonGeneral($oControl, "Renamed_AutoIt_Control", "An AutoIt Labeled Control", $oGroupBox, Null, Null, True, True, True, True, 1, $LOW_FORM_CONTROL_CHKBX_STATE_SELECTED, $mFont, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_ALIGN_HORI_CENTER, $LOW_ALIGN_VERT_BOTTOM, $LOW_COLOR_GOLD, False, Null, Null, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlOptionButtonGeneral($oControl)
