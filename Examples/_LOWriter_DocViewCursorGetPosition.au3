...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The ViewCursor is located at the following position:" & @CRLF & _
			"Horizontal, measured in Hundredths of a Millimeter (100th MM): " & $iReturn & @CRLF & _
			"Vertical, measured in Hundredths of a Millimeter (100th MM): " & @extended & @CRLF & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The ViewCursor is now located at the following position:" & @CRLF & _
			"Horizontal, measured in Hundredths of a Millimeter (100th MM): " & $iReturn & @CRLF & _
			"Vertical, measured in Hundredths of a Millimeter (100th MM): " & @extended)
