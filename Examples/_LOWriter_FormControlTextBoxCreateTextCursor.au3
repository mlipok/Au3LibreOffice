...
Func Example()
	...
	_LOWriter_FormControlTextBoxGeneral($oControl, "Renamed_AutoIt_Control", Null, Null, 175, True, True, False, True, True, 1, "Please Enter Some Text", $mFont, $LOW_ALIGN_HORI_LEFT, $LOW_ALIGN_VERT_MIDDLE, $LOW_COLOR_TEAL, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_COLOR_GOLD, $LOW_FORM_CONTROL_TXT_TYPE_MULTI_LINE_FORMATTED, False, $LOW_FORM_CONTROL_SCROLL_BOTH, Null, True)
	...
	$oCursor = _LOWriter_FormControlTextBoxCreateTextCursor($oControl)
