...
Func Example()
	...
	If @error Then Return _ERROR($oDoc, "Failed to retrieve an array of Query field names. Error:" & @error & " Extended:" & @extended)

	For $i = 0 To @extended - 1
		$sFields &= $asQueries[$i] & @CRLF
	Next

	MsgBox($MB_OK, "", "This Query contains the following Fields:" & @CRLF & $sFields)
