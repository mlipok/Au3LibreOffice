...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to modify a Filter Field. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to Modify a Filter Descriptor. Error:" & @error & " Extended:" & @extended)
