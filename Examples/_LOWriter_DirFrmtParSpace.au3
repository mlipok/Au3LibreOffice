...
Func Example()
	...
	_LOWriter_DirFrmtParSpace($oViewCursor, $i100thMM, $i100thMM, True, $LOW_LINE_SPC_MODE_FIX, $i100thMM2, False)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The current Paragraph Line Spacing settings are as follows: " & @CRLF & _
			"Spacing above the paragraph, in Hundredths of a Millimeter (100th MM): " & $avSettings[0] & @CRLF & _
			"Spacing below the paragraph, in Hundredths of a Millimeter (100th MM): " & $avSettings[1] & @CRLF & _
			...
			"Line spacing distance, in Hundredths of a Millimeter (100th MM) except for $LOW_LINE_SPC_MODE_PROP(0), which is a percentage: " & $avSettings[4] & @CRLF & @CRLF & _
