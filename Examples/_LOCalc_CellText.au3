...
Func Example()
	...
	If @error Then _ERROR("Failed to Retrieve A1 Cell content. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	$sContent = _LOCalc_CellText($oCell)
	If @error Then _ERROR("Failed to Retrieve B2 Cell content. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	If @error Then _ERROR("Failed to retrieve D1 Cell Object. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Set D1 Cell Formula to "=2+2"
	_LOCalc_CellFormula($oCell, "=2+2")
	If @error Then _ERROR("Failed to Set D1 Cell content. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Retrieve Cell D1's Text.
	$sContent = _LOCalc_CellText($oCell)
	If @error Then _ERROR("Failed to Retrieve D1 Cell content. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
