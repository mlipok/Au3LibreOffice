...
Func Example()
	...
	_LOWriter_ImageWrap($oImage, $LOW_WRAP_MODE_LEFT, $i100thMM, $i100thMM, $i100thMM2, $i100thMM2)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Image's wrap settings are as follows: " & @CRLF & _
			...
			"The spacing between the Left edge of the Image and any text is, in Hundredths of a Millimeter (100th MM): " & $avSettings[1] & @CRLF & _
			"The spacing between the Right edge of the Image and any text is, in Hundredths of a Millimeter (100th MM): " & $avSettings[2] & @CRLF & _
			"The spacing between the Top edge of the Image and any text is, in Hundredths of a Millimeter (100th MM): " & $avSettings[3] & @CRLF & _
			"The spacing between the Bottom edge of the Image and any text is, in Hundredths of a Millimeter (100th MM): " & $avSettings[4])
