...
Func Example()
	...
	_LOBase_ReportPageFooter($oReportDoc, True, "AutoIt_Section", True, 4500, Null, $LOB_COLOR_TEAL)
	...
	$avReport = _LOBase_ReportPageFooter($oReportDoc)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Section's current settings are: " & @CRLF & _
			...
			"The Height of the section is, in Micrometers: " & $avReport[3] & @CRLF & _
