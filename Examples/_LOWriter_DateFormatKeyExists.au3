...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to search for a Date/Time Format Key. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to delete a Date/Time Format Key. Error:" & @error & " Extended:" & @extended)
