...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Cell B2's Border Width settings are as follows (in Hundredths of a Millimeter (100th MM)): " & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Cell Range D2-E5's Border Width settings are as follows (in Hundredths of a Millimeter (100th MM)): " & @CRLF & _
			"Top Border Width: " & $avSettings[0] & @CRLF & _
			"Bottom Border Width: " & $avSettings[1] & @CRLF & _
			"Left Border Width: " & $avSettings[2] & @CRLF & _
			"Right Border Width: " & $avSettings[3] & @CRLF & _
