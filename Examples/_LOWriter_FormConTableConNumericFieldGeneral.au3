...
Func Example()
	...
	; Convert 1.25 inches to Hundredths of a Millimeter (100th MM)
	$iWidth = _LO_UnitConvert(1.25, $LO_CONVERT_UNIT_INCH_100THMM)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Column's current settings are: " & @CRLF & _
			...
			"The Column's width is, in Hundredths of a Millimeter (100th MM): " & $avColumn[16] & @CRLF & _
