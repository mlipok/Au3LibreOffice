...
Func Example()
	...
	$oControl = _LOWriter_FormConInsert($oForm, $LOW_FORM_CONTROL_TYPE_PUSH_BUTTON, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormConPushButtonGeneral($oControl, "Renamed_AutoIt_Control", "Push Me", Null, True, True, True, True, 1, True, 150, True, False, $LOW_FORM_CONTROL_CHKBX_STATE_NOT_SELECTED, $mFont, $LOW_ALIGN_HORI_CENTER, $LOW_ALIGN_VERT_MIDDLE, $LOW_COLOR_GOLD, False, $LOW_FORM_CONTROL_PUSH_CMD_OPEN, "https://www.autoitscript.com/site/autoit/", $LOW_FRAME_TARGET_TOP, True, Null, Null, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
