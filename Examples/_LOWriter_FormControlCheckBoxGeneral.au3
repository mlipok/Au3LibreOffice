...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_CHECK_BOX, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormControlCheckBoxGeneral($oControl, "Renamed_AutoIt_Control", "This is a CheckBox", $oLabel, Null, True, True, False, True, 2, _
	...
	$avControl = _LOWriter_FormControlCheckBoxGeneral($oControl)
