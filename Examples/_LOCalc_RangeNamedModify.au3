...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve the Named Range settings. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to set Named Range settings. Error:" & @error & " Extended:" & @extended)
