...
Func Example()
	...
	; Modify the Comment Arrow Style settings to: Starting Arrow Style = $LOC_COMMENT_LINE_ARROW_TYPE_CF_MANY_ONE, Starting Arrow Width = 550 Hundredths of a Millimeter (100th MM),
	...
	; Set the end Arrow width to 350 Hundredths of a Millimeter (100th MM), and don't center the arrow head on the line.
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Comment's Line Arrow Style settings are as follows: " & @CRLF & _
			...
			"The Start Line Arrow Width is, in Hundredths of a Millimeter (100th MM): " & $avSettings[1] & @CRLF & _
			...
			"The End Line Arrow Width is, in Hundredths of a Millimeter (100th MM): " & $avSettings[5] & @CRLF & _
