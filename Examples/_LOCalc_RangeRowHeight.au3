...
Func Example()
	...
	_LOCalc_RangeRowHeight($oRow, Null, $i100thMM)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Row 5's Height settings are:" & @CRLF & _
			...
			"Row 5's current height is, in Hundredths of a Millimeter (100th MM): " & $avHeight[1] & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Row 5's new Height settings are:" & @CRLF & _
			"Is the Row's height set to optimal? True/False: " & $avHeight[0] & @CRLF & _
			"Row 5's current height is, in Hundredths of a Millimeter (100th MM): " & $avHeight[1])
