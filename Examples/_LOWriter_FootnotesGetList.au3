...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve an array of Footnote objects. Error:" & @error & " Extended:" & @extended)

	; Delete the first Footnote returned
	_LOWriter_FootnoteDelete($aoFootnotes[0])
	If @error Then _ERROR($oDoc, "Failed to delete a Footnote. Error:" & @error & " Extended:" & @extended)
