...
Func Example()
	...
	; Indent = 1/4"
	_LOCalc_CellStyleTextAlign($oCellStyle, $LOC_CELL_ALIGN_HORI_LEFT, $LOC_CELL_ALIGN_VERT_MIDDLE, $i100thMM)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Cell Style's current Text Alignment settings are as follows: " & @CRLF & _
			...
			"The amount of Indentation is (in Hundredths of a Millimeter (100th MM)): " & $avSettings[2])
