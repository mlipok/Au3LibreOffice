...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Calc Document name. Error:" & @error & " Extended:" & @extended)
	...
	If (@error > 0) Or Not IsObj($oDoc2) Then _ERROR($oDoc, "Failed to Connect to Calc Document. Error:" & @error & " Extended:" & @extended)
