...
Func Example()
	...
	_LOWriter_ParStyleIndent($oParStyle, $i100thMM, $i100thMM2, $i100thMM3, False)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Paragraph's current Indent settings are as follows: " & @CRLF & _
			"Indent spacing before the paragraph, in Hundredths of a Millimeter (100th MM): " & $avParStyleSettings[0] & @CRLF & _
			"Spacing after the paragraph, in Hundredths of a Millimeter (100th MM): " & $avParStyleSettings[1] & @CRLF & _
			"First line Indent spacing, in Hundredths of a Millimeter (100th MM): " & $avParStyleSettings[2] & @CRLF & _
