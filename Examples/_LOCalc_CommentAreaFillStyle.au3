...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve comment Area Fill Style. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "The Comment's current Fill Style is: " & $iFillStyle & @CRLF & _
