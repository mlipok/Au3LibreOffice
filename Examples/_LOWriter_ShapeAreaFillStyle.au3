...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Shape Fill Style. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "The Shape's current Fill Style is: " & $iFillStyle & @CRLF & _
