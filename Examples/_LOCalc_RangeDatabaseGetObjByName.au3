...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to add Cell Range to list of Database Ranges. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Database Ranges list. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Database Range Object. Error:" & @error & " Extended:" & @extended)

	; Delete the Database Range "My AutoIt Range" using its Object.
	_LOCalc_RangeDatabaseDelete($oDoc, $oDatabaseRange)
	If @error Then _ERROR($oDoc, "Failed to delete Database Range. Error:" & @error & " Extended:" & @extended)
