...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Image's Fill Style. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "The Image's current Fill Style is: " & $iFillStyle & @CRLF & _
