...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Image's size settings are as follows: " & @CRLF & _
			"The Image width is, in Hundredths of a Millimeter (100th MM): " & $avSettings[0] & @CRLF & _
			...
			"The Image height is, in Hundredths of a Millimeter (100th MM): " & $avSettings[3] & @CRLF & _
