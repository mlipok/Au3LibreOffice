...
Func Example()
	...
	If @error Then Return _ERROR($oDoc, "Failed to retrieve current primary key. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then Return _ERROR($oDoc, "Failed to set Table Primary key. Error:" & @error & " Extended:" & @extended)
