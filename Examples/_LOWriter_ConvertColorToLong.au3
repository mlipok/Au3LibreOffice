...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to convert RGB color value to Long color format integer. Error:" & @error & " Extended:" & @extended)

	; Convert Hex to Long color format, Hex is input as a string.
	$iHEX_TO_LONG = _LOWriter_ConvertColorToLong("bf0041")
	If @error Then _ERROR($oDoc, "Failed to convert HEX color value to Long color format integer. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to convert CMYK color value to Long color format integer. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to convert HSB color value to Long color format integer. Error:" & @error & " Extended:" & @extended)
