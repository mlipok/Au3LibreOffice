...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Table settings. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to set TableBreak settings. Error:" & @error & " Extended:" & @extended)

	; Retrieve the third down (Row 2) settings again.
	$avTableBreak = _LOWriter_TableBreak($oDoc, $oTable)
	If @error Then _ERROR($oDoc, "Failed to retrieve row settings. Error:" & @error & " Extended:" & @extended)
