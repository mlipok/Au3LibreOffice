...
Func Example()
	...
	; Set Page style Header Shadow settings to: Width = 1/8", Color = $LO_COLOR_RED, Location = $LOC_SHADOW_TOP_LEFT
	_LOCalc_PageStyleHeaderShadow($oPageStyle, $iHMM, $LO_COLOR_RED, $LOC_SHADOW_TOP_LEFT)
