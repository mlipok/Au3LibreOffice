...
Func Example()
	...
	; Convert 1/2 an inch to Hundredths of a Millimeter (100th MM)
	...
	_LOCalc_RangeColumnWidth($oColumn, Null, $i100thMM)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Column C's Width settings are:" & @CRLF & _
			...
			"Column C's current Width is, in Hundredths of a Millimeter (100th MM): " & $avWidth[1] & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Column C's new Width settings are:" & @CRLF & _
			"Is the Column's Width set to optimal? True/False: " & $avWidth[0] & @CRLF & _
			"Column C's current Width is, in Hundredths of a Millimeter (100th MM): " & $avWidth[1])
