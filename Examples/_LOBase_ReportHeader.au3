...
Func Example()
	...
	_LOBase_ReportHeader($oReportDoc, True, "AutoIt_Section", $LOB_REP_FORCE_PAGE_AFTER_SECTION, False, True, 4500, Null, $LOB_COLOR_TEAL)
	...
	$avReport = _LOBase_ReportHeader($oReportDoc)
