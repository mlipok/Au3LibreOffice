...
Func Example()
	...
	$oGroupBox = _LOWriter_FormConInsert($oForm, $LOW_FORM_CONTROL_TYPE_GROUP_BOX, 2000, 2300, 6000, 2000, "AutoIt_Form_Control2")
	If @error Then _ERROR($oDoc, "Failed to insert a form control. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	_LOWriter_FormConOptionButtonGeneral($oControl, "Renamed_AutoIt_Control", "An AutoIt Labeled Control", $oGroupBox, Null, Null, True, True, True, True, 1, $LOW_FORM_CONTROL_CHKBX_STATE_SELECTED, $mFont, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_ALIGN_HORI_CENTER, $LOW_ALIGN_VERT_BOTTOM, $LOW_COLOR_GOLD, False, Null, Null, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
