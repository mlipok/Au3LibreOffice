...
Func Example()
	...
	; Modify the Comment Callout settings to: Callout connector line style = Angled, Line connection spacing from Comment box = 100 Hundredths of a Millimeter (100th MM),
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Comment's Callout settings are as follows: " & @CRLF & _
			...
			"The Callout Connector line spacing from the comment box is, in Hundredths of a Millimeter (100th MM): " & $avSettings[1] & @CRLF & _
			...
			"The length of the Callout line is, in Hundredths of a Millimeter (100th MM) (Only used if Optimal sizing is false): " & $avSettings[5])
