...
Func Example()
	...
	If @error Then Return _ERROR($oDoc, "Failed to retrieve count of forms. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then Return _ERROR($oDoc, "Failed to retrieve a count of Forms. Error:" & @error & " Extended:" & @extended)
