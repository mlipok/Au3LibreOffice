...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to Set the Numbering Style. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Paragraph Objects. Error:" & @error & " Extended:" & @extended)
