...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to convert to RGB color value from Long color format integer. Error:" & @error & " Extended:" & @extended)

	; Convert to Hex From Long color format, Hex is returned as a string.
	$sHex = _LOWriter_ConvertColorFromLong($LOW_COLOR_MAGENTA)
	If @error Then _ERROR($oDoc, "Failed to convert to HEX color value from Long color format integer. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to convert to CMYK color value from Long color format integer. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to convert to HSB color value from Long color format integer. Error:" & @error & " Extended:" & @extended)
