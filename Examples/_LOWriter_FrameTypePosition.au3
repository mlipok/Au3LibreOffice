...
Func Example()
	...
	_LOWriter_FrameTypePosition($oFrame, $LOW_ORIENT_HORI_CENTER, Null, $LOW_RELATIVE_PAGE, True, $LOW_ORIENT_VERT_NONE, $i100thMM, _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Frame's position settings are as follows: " & @CRLF & _
			...
			"The frame's Horizontal position is, in Hundredths of a Millimeter (100th MM): " & $avSettings[1] & @CRLF & _
			...
			"The frame's Vertical position is, in Hundredths of a Millimeter (100th MM): " & $avSettings[5] & @CRLF & _
