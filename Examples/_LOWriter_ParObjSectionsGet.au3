...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to insert a footnote. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve array of Paragraph Object sections. Error:" & @error & " Extended:" & @extended)
