...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_IMAGE_BUTTON, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormControlImageButtonGeneral($oControl, "Renamed_AutoIt_Control", Null, True, True, False, True, 1, $LOW_COLOR_BLUE, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_COLOR_GREEN, $LOW_FORM_CONTROL_PUSH_CMD_OPEN, "https://www.autoitscript.com/site/autoit/", $LOW_FRAME_TARGET_TOP, @ScriptDir & "\Extras\Plain.png", $LOW_FORM_CONTROL_IMG_BTN_SCALE_FIT, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlImageButtonGeneral($oControl)
