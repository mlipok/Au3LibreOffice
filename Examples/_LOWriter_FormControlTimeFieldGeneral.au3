...
Func Example()
	...
	_LOWriter_FormControlTimeFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, True, True, True, False, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_FOCUS, True, 1, $tTimeMin, $tTimeMax, $LOW_FORM_CONTROL_TIME_FRMT_12_LONG, $tTimeDefault, True, True, 50, $mFont, $LOW_ALIGN_HORI_LEFT, $LOW_ALIGN_VERT_MIDDLE, $LOW_COLOR_GREEN, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_COLOR_GOLD, False, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlTimeFieldGeneral($oControl)
