...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to Create or Retrieve Number Format Key. Error:" & @error & " Extended:" & @extended)

	; Set Cell B5's Numbering Format to the format key I just retrieved.
	_LOCalc_CellNumberFormat($oDoc, $oCell, $iFormatKey)
	If @error Then _ERROR($oDoc, "Failed to set Cell Numbering Format. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to set Cell Range Numbering Format. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Cell Numbering Format setting. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Cell Range Numbering Format setting. Error:" & @error & " Extended:" & @extended)
