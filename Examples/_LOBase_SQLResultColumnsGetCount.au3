...
Func Example()
	...
	If @error Then Return _ERROR($oDoc, "Failed to retrieve a count of columns returned in the SQL Result Set. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "The Result set contains " & $iColumns & " Columns.")
