...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Frame's size settings are as follows: " & @CRLF & _
			"The Frame's width is, in Hundredths of a Millimeter (100th MM): " & $avSettings[0] & @CRLF & _
			...
			"The Frame's height is, in Hundredths of a Millimeter (100th MM): " & $avSettings[4] & @CRLF & _
