...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_FILE_SELECTION, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormControlFileSelFieldGeneral($oControl, "Renamed_AutoIt_Control", Null, True, True, False, True, True, 1, "Please select a file.", $mFont, $LOW_ALIGN_HORI_LEFT, $LOW_ALIGN_VERT_MIDDLE, $LOW_COLOR_GRAY, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_COLOR_GREEN, False, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlFileSelFieldGeneral($oControl)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"The Long Integer background color is: " & $avControl[12] & @CRLF & _
			"The Border Style is (See UDF Constants): " & $avControl[13] & @CRLF & _
			"The Border color is, in Long Integer format: " & $avControl[14] & @CRLF & _
