...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Comment's Text Animation settings are as follows: " & @CRLF & _
			...
			"The Animation will be Incremented by: " & $avSettings[5] & " pixels. (May be 0 if the current setting is in Hundredths of a Millimeter (100th MM).)" & @CRLF & _
			"The Animation will be Incremented by: " & $avSettings[6] & " Hundredths of a Millimeter (100th MM). (May be 0 if the current setting is in Pixels.)" & @CRLF & _
