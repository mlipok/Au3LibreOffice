...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_DATE_FIELD, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormControlDateFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, True, True, True, False, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_FOCUS, True, 1, $tDateMin, $tDateMax, $LOW_FORM_CONTROL_DATE_FRMT_SHORT_YYYYMMDD, $tDateDefault, True, True, 50, $mFont, $LOW_ALIGN_HORI_LEFT, $LOW_ALIGN_VERT_MIDDLE, $LOW_COLOR_GREEN, $LOW_FORM_CONTROL_BORDER_FLAT, $LOW_COLOR_GOLD, True, False, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlDateFieldGeneral($oControl)
