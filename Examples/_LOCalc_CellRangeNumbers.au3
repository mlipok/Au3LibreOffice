...
Func Example()
	...
	MsgBox($MB_OK, "", "I will now fill Cell Range A1 to B4 with Numbers." & @CRLF & _
			"I will then replace Cell A3 with a String, and B1 with a formula, to demonstrate what is returned by _LOCalc_CellRangeNumbers when it encounters these data types.")
	...
	$aavData = _LOCalc_CellRangeNumbers($oCellRange)
