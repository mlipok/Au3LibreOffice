...
Func Example()
	...
	; Set Page style Footer Shadow settings to: Width = 1/8", Color = $LO_COLOR_RED, Location = $LOW_SHADOW_TOP_LEFT
	_LOWriter_PageStyleFooterShadow($oPageStyle, $iHMM, $LO_COLOR_RED, $LOW_SHADOW_TOP_LEFT)
