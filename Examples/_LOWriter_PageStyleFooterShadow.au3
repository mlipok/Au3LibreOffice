...
Func Example()
	...
	; Set Page style Footer Shadow settings to: Width = 1/8", Color = $LO_COLOR_RED, Transparent = False, Location = $LOW_SHADOW_TOP_LEFT
	_LOWriter_PageStyleFooterShadow($oPageStyle, $iMicrometers, $LO_COLOR_RED, False, $LOW_SHADOW_TOP_LEFT)
