...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to create Text Table cursor. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to move Table Cursor. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to merge Table cells. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to Split Table cell. Error:" & @error & " Extended:" & @extended)
