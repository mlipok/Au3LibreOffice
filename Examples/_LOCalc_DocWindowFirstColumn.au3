...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve first visible Column. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to set first visible Column. Error:" & @error & " Extended:" & @extended)
