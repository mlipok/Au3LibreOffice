...
Func Example()
	...
	_LOCalc_PageStyleFooter($oPageStyle, True, False, True, $i100thMM, $i100thMM, $i100thMM2, Null, True)
	If @error Then _ERROR($oDoc, "Failed to modify Page Style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Page Style's current Footer settings are as follows: " & @CRLF & _
			...
			"The height of the Footer, in Hundredths of a Millimeter (100th MM): " & $avPageStyleSettings[6] & @CRLF & _
