...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to set Column Heading Range. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Column repeat Range. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to set Repeat Column Range. Error:" & @error & " Extended:" & @extended)

	; Retrieve the current print ranges set for this sheet.
	$avSettings = _LOCalc_SheetPrintColumnsRepeat($oSheet)
	If @error Then _ERROR($oDoc, "Failed to retrieve Column Repeat Range array. Error:" & @error & " Extended:" & @extended)
