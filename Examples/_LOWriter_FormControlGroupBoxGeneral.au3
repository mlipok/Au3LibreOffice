...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_GROUP_BOX, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormControlGroupBoxGeneral($oControl, "Renamed_AutoIt_Control", "This is a GroupBox", Null, True, True, False, $mFont, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlGroupBoxGeneral($oControl)
