...
Func Example()
	...
	$oControl = _LOWriter_FormControlInsert($oForm, $LOW_FORM_CONTROL_TYPE_CURRENCY_FIELD, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	$mFont = _LOWriter_FontDescCreate($oDoc, "Times New Roman", $LOW_WEIGHT_BOLD, $LOW_POSTURE_ITALIC, 18, $LOW_COLOR_INDIGO, $LOW_UNDERLINE_BOLD, $LOW_COLOR_GREEN, $LOW_STRIKEOUT_NONE, True, $LOW_RELIEF_NONE)
	...
	_LOWriter_FormControlCurrencyFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, True, True, True, True, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_FOCUS, True, 1, _
			12.50, 100.75, 1, 13.50, 2, False, "$", True, True, False, Null, $mFont, $LOW_ALIGN_HORI_RIGHT, $LOW_ALIGN_VERT_TOP, $LOW_COLOR_GREEN, _
			$LOW_FORM_CONTROL_BORDER_WITHOUT, $LOW_COLOR_GOLD, True, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlCurrencyFieldGeneral($oControl)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"The Long Integer background color is: " & $avControl[25] & @CRLF & _
			"The Border Style is (See UDF Constants): " & $avControl[26] & @CRLF & _
			"The Border color is, in Long Integer format: " & $avControl[27] & @CRLF & _
