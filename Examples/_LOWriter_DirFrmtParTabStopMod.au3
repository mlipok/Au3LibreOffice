...
Func Example()
	...
	$iTabStop = _LOWriter_DirFrmtParTabStopCreate($oViewCursor, $i100thMM)
	...
	_LOWriter_DirFrmtParTabStopMod($oViewCursor, $iTabStop, $i100thMM, Asc("~"), $LOW_TAB_ALIGN_DECIMAL, Asc("."))
	$iTabStop = @extended
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Tab stop, having the position of " & $iTabStop & " has the following settings: " & @CRLF & _
			"The Current position is, in Hundredths of a Millimeter (100th MM): " & $avTabStop[0] & @CRLF & _
