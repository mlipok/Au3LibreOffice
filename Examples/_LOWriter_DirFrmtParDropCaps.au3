...
Func Example()
	...
	_LOWriter_DirFrmtParDropCaps($oDoc, $oViewCursor, 3, 2, $i100thMM, False, "Example")
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The current Paragraph DropCap settings are as follows: " & @CRLF & _
			...
			"How much distance between the DropCaps and the rest of the text? In Hundredths of a Millimeter (100th MM): " & $avSettings[2] & @CRLF & _
