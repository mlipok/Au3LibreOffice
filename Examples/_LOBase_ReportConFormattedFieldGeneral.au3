...
Func Example()
	...
	_LOBase_ReportConFormattedFieldGeneral($oControl, "Renamed_AutoIt_Control", 'rpt:COUNT(1;1)=VALUE("2")', True, True, $LOB_COLOR_GRAY, $mFont, $LOB_TXT_ALIGN_HORI_CENTER, $LOB_ALIGN_VERT_BOTTOM, $iFormat)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"The Long Integer background color is: " & $avControl[4] & @CRLF & _
