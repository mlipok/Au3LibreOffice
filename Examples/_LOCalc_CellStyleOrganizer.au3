...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to modify Cell Style settings. Error:" & @error & " Extended:" & @extended)
	...
	MsgBox($MB_OK, "", "The Cell Style's current Organizer settings are as follows: " & @CRLF & _
