...
Func Example()
	...
	; Set the Cell's Border color to $LOC_COLOR_BRICK for all four sides.
	...
	MsgBox($MB_OK, "", "Cell B2's Border color settings are as follows: " & @CRLF & _
	...
	; Set the Cell's Border color to $LOC_COLOR_BRICK for all four sides, and $LOC_COLOR_BLUE for the vertical and diagonal borders.
	...
	MsgBox($MB_OK, "", "Cell Range D2-E5's Border color settings are as follows: " & @CRLF & _
			"Top Border color, in Long Color Format: " & $avSettings[0] & @CRLF & _
			"Bottom Border color, in Long Color Format: " & $avSettings[1] & @CRLF & _
			"Left Border color, in Long Color Format: " & $avSettings[2] & @CRLF & _
			"Right Border color, in Long Color Format: " & $avSettings[3] & @CRLF & _
