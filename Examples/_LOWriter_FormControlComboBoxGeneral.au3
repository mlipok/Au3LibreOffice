...
Func Example()
	...
	_LOWriter_FormControlComboBoxGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, 35, True, True, False, True, $LOW_FORM_CONTROL_MOUSE_SCROLL_FOCUS, True, _
			1, $asComboItems, "Select an Option", $mFont, $LOW_ALIGN_HORI_CENTER, $LOW_COLOR_BRICK, $LOW_FORM_CONTROL_BORDER_3D, $LOW_COLOR_GREEN, True, 2, True, _
	...
	$avControl = _LOWriter_FormControlComboBoxGeneral($oControl)
