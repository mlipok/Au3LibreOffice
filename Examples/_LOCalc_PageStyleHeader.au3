...
Func Example()
	...
	$iMicrometers = _LOCalc_ConvertToMicrometer(.25)
	...
	_LOCalc_PageStyleHeader($oPageStyle, True, False, True, $iMicrometers, $iMicrometers, $iMicrometers2, Null, True)
	If @error Then _ERROR($oDoc, "Failed to modify Page Style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	MsgBox($MB_OK, "", "The Page Style's current Header settings are as follows: " & @CRLF & _
			...
			"The height of the Header, in Micrometers: " & $avPageStyleSettings[6] & @CRLF & _
