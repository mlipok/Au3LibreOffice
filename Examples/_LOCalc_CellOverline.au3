...
Func Example()
	...
	_LOCalc_CellOverLine($oCell, True, $LOC_UNDERLINE_BOLD_DASH_DOT, True, $LOC_COLOR_BROWN)
	...
	MsgBox($MB_OK, "", "The Cell's current Overline settings are as follows: " & @CRLF & _
