...
Func Example()
	...
	$oControl = _LOWriter_FormConInsert($oForm, $LOW_FORM_CONTROL_TYPE_TABLE_CONTROL, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormConTableConGeneral($oControl, "Renamed_AutoIt_Control", Null, True, True, True, True, 1, $mFont, 1500, $LOW_COLOR_GOLD, $LOW_FORM_CONTROL_BORDER_FLAT, True, True, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
