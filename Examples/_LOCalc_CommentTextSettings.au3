...
Func Example()
	...
	; Set left and right spacing to 170 Hundredths of a Millimeter (100th MM), set top and bottom spacing to 120 Hundredths of a Millimeter (100th MM).
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Comment's Text settings are as follows: " & @CRLF & _
			...
			"The Spacing for all of the borders is, in Hundredths of a Millimeter (100th MM) (Will be 0 if they are not all equal): " & $avSettings[3] & @CRLF & _
			"The Left side Spacing between the text and the Comment box border is, in Hundredths of a Millimeter (100th MM): " & $avSettings[4] & @CRLF & _
			"The Right side Spacing between the text and the Comment box border is, in Hundredths of a Millimeter (100th MM): " & $avSettings[5] & @CRLF & _
			"The Top Spacing between the text and the Comment box border is, in Hundredths of a Millimeter (100th MM): " & $avSettings[6] & @CRLF & _
			"The Bottom Spacing between the text and the Comment box border is, in Hundredths of a Millimeter (100th MM): " & $avSettings[7])
