...
Func Example()
	...
	_LOWriter_FormControlListBoxGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, True, True, False, False, $LOW_FORM_CONTROL_MOUSE_SCROLL_DISABLED, True, 2, $asListEntries, $mFont, $LOW_ALIGN_HORI_LEFT, $LOW_COLOR_BLUE, $LOW_FORM_CONTROL_BORDER_3D, $LOW_COLOR_GREEN, False, 3, True, $aiSelected, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormControlListBoxGeneral($oControl)
