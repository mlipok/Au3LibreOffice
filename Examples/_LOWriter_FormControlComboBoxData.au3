...
Func Example()
	...
	_LOWriter_FormControlComboBoxData($oControl, "Datafield1", False, True, $LOW_FORM_CONTROL_SOURCE_TYPE_TABLE, "Testing_1")
	...
	$avControl = _LOWriter_FormControlComboBoxData($oControl)
