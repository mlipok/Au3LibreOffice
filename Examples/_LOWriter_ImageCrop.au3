...
Func Example()
	...
	_LOWriter_ImageCrop($oImage, $i100thMM, $i100thMM, $i100thMM2, $i100thMM2, False)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Image's crop settings are as follows: " & @CRLF & _
			"The image's left crop value, in Hundredths of a Millimeter (100th MM) is: " & $avSettings[0] & @CRLF & _
			"The image's Right crop value, in Hundredths of a Millimeter (100th MM) is: " & $avSettings[1] & @CRLF & _
			"The image's Top crop value, in Hundredths of a Millimeter (100th MM) is: " & $avSettings[2] & @CRLF & _
			"The image's Bottom crop value, in Hundredths of a Millimeter (100th MM) is: " & $avSettings[3] & @CRLF & _
