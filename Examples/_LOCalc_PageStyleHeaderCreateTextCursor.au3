...
Func Example()
	...
	MsgBox($MB_OK, "", "To see the new text, switch to Page Styles in the UI, go to Modify the ""Default"" page style, select Header, select Edit, and look at ""Header(Rest)"" tab." & @CRLF & _
