...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Page Style's current Paper Format settings are as follows: " & @CRLF & _
			"The paper width, in Hundredths of a Millimeter (100th MM), is: " & $avPageStyleSettings[0] & @CRLF & _
			"The paper Height in Hundredths of a Millimeter (100th MM), is: " & $avPageStyleSettings[1] & @CRLF & _
