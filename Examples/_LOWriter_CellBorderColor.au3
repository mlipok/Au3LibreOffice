...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell Border Color settings. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR($oDoc, "Failed to retrieve Text Table cell Border Color settings. Error:" & @error & " Extended:" & @extended)
