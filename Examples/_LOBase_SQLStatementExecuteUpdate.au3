...
Func Example()
	...
	MsgBox(0, "", "Press Ok to add 120 posts to all users entered in the Table that have a Post count less than 12,000.")
	...
	If @error Then Return _ERROR($oDoc, "Failed to Execute a SQL Statement Update. Error:" & @error & " Extended:" & @extended)

	; Open the Table UI.
	$oTableUI = _LOBase_DocTableUIOpenByObject($oDoc, $oConnection, $oTable)
	If @error Then Return _ERROR($oDoc, "Failed to open Table User Interface. Error:" & @error & " Extended:" & @extended)

	MsgBox(0, "", "I have added 120 posts to those users who had less than 12,000 posts. " & $iReturn & " Users were affected." & @CRLF & _
