...
Func Example()
	...
	$oControl = _LOWriter_FormConInsert($oForm, $LOW_FORM_CONTROL_TYPE_NAV_BAR, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormConNavBarGeneral($oControl, "Renamed_AutoIt_Control", Null, True, True, True, 2, 50, $mFont, $LOW_COLOR_GOLD, $LOW_FORM_CONTROL_BORDER_3D, False, True, True, True, True, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
