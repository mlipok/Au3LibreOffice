...
; Related .......: _LOWriter_ImageInsert, _LOWriter_ImageGetObjByName, _LOWriter_ConvertColorFromLong,
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iTop                - [optional] an integer value (0-16777215). Default is Null. Sets the Top Border Line Color of the Image in Long Color code format. Can be a custom value, or one of the constants, $LOW_COLOR_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iBottom             - [optional] an integer value (0-16777215). Default is Null. Sets the Bottom Border Line Color of the Image in Long Color code format. Can be a custom value, or one of the constants, $LOW_COLOR_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iLeft               - [optional] an integer value (0-16777215). Default is Null. Sets the Left Border Line Color of the Image in Long Color code format. Can be a custom value, or one of the constants, $LOW_COLOR_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iRight              - [optional] an integer value (0-16777215). Default is Null. Sets the Right Border Line Color of the Image in Long Color code format. Can be a custom value, or one of the constants, $LOW_COLOR_* as defined in LibreOfficeWriter_Constants.au3.
; Return values .: Success: 1 or Array.
;				   Failure: 0 and sets the @Error and @Extended flags to non-zero.
;				   --Input Errors--
;				   @Error 1 @Extended 1 Return 0 = $oImage not an Object.
...
;					Call any optional parameter with Null keyword to skip it.
; Related .......: _LOWriter_ImageInsert, _LOWriter_ImageGetObjByName, _LOWriter_ConvertColorFromLong,
;					_LOWriter_ConvertColorToLong, _LOWriter_ImageBorderWidth, _LOWriter_ImageBorderStyle,
;					_LOWriter_ImageBorderPadding
; Link ..........:
; Example .......: Yes
; ===============================================================================================================================
...
; Remarks .......: Call this function with only the required parameters (or with all other parameters set to Null keyword), to get the current settings.
;					Call any optional parameter with Null keyword to skip it.
; Related .......: _LOWriter_ImageInsert, _LOWriter_ImageGetObjByName, _LOWriter_ConvertFromMicrometer,
;					_LOWriter_ConvertToMicrometer, _LOWriter_ImageBorderWidth, _LOWriter_ImageBorderStyle,
;					_LOWriter_ImageBorderColor
; Link ..........:
; Example .......: Yes
; ===============================================================================================================================
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iTop                - [optional] an integer value (0x7FFF-17). Default is Null. Sets the Top Border Line Style of the Image using one of the line style constants, $LOW_BORDERSTYLE_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iBottom             - [optional] an integer value (0x7FFF-17). Default is Null. Sets the Bottom Border Line Style of the Image using one of the line style constants, $LOW_BORDERSTYLE_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iLeft               - [optional] an integer value (0x7FFF-17). Default is Null. Sets the Left Border Line Style of the Image using one of the line style constants, $LOW_BORDERSTYLE_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iRight              - [optional] an integer value (0x7FFF-17). Default is Null. Sets the Right Border Line Style of the Image using one of the line style constants, $LOW_BORDERSTYLE_* as defined in LibreOfficeWriter_Constants.au3.
; Return values .: Success: 1 or Array.
;				   Failure: 0 and sets the @Error and @Extended flags to non-zero.
;				   --Input Errors--
;				   @Error 1 @Extended 1 Return 0 = $oImage not an Object.
...
;					Call this function with only the required parameters (or with all other parameters set to Null keyword), to get the current settings.
;					Call any optional parameter with Null keyword to skip it.
; Related .......: _LOWriter_ImageInsert, _LOWriter_ImageGetObjByName, _LOWriter_ImageBorderWidth,
;					_LOWriter_ImageBorderColor, _LOWriter_ImageBorderPadding
; Link ..........:
; Example .......: Yes
; ===============================================================================================================================
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iTop                - [optional] an integer value. Default is Null. Sets the Top Border Line width of the Image in MicroMeters. Can be a custom value, or one of the constants, $LOW_BORDERWIDTH_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iBottom             - [optional] an integer value. Default is Null. Sets the Bottom Border Line Width of the Image in MicroMeters. Can be a custom value, or one of the constants, $LOW_BORDERWIDTH_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iLeft               - [optional] an integer value. Default is Null. Sets the Left Border Line width of the Image in MicroMeters. Can be a custom value, or one of the constants, $LOW_BORDERWIDTH_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iRight              - [optional] an integer value. Default is Null. Sets the Right Border Line Width of the Image in MicroMeters. Can be a custom value, or one of the constants, $LOW_BORDERWIDTH_* as defined in LibreOfficeWriter_Constants.au3.
; Return values .: Success: 1 or Array.
;				   Failure: 0 and sets the @Error and @Extended flags to non-zero.
;				   --Input Errors--
;				   @Error 1 @Extended 1 Return 0 = $oImage not an Object.
...
;					Call any optional parameter with Null keyword to skip it.
; Related .......: _LOWriter_ImageInsert, _LOWriter_ImageGetObjByName, _LOWriter_ConvertFromMicrometer,
;					_LOWriter_ConvertToMicrometer, _LOWriter_ImageBorderStyle, _LOWriter_ImageBorderColor,
;					_LOWriter_ImageBorderPadding
; Link ..........:
; Example .......: Yes
; ===============================================================================================================================
...
; Author ........: donnyh13
; Modified ......:
; Remarks .......: Note: $bInvert is glitchy to set. The current setting will always be returned as false if set by the user.
;						Setting inverted using this function can be difficult to remove by the user.
;					Call this function with only the required parameters (or with all other parameters set to Null keyword), to get the current settings.
;					Call any optional parameter with Null keyword to skip it.
; Related .......: _LOWriter_ImageInsert, _LOWriter_ImageGetObjByName
; Link ..........:
...
;				   --Input Errors--
;				   @Error 1 @Extended 1 Return 0 = $oImage not an Object.
;				   @Error 1 @Extended 2 Return 0 = $bKeepScale not a Boolean, and not set to Null.
...
;				   @Error 1 @Extended 2 Return 0 = $oImage not an Object.
;				   --Processing Errors--
;				   @Error 3 @Extended 1 Return 0 = Image was attempted to be deleted, but the document still contains a Image named the same.
;				   --Success--
...
;				   @Error 1 @Extended 4 Return 0 = $iAnchorType not an integer, less than 0, or greater than 2 and not equal to 4.
;				   @Error 1 @Extended 5 Return 0 = $bOverwrite not a Boolean.
;				   @Error 1 @Extended 6 Return 0 = $oCursor is a Table Cursor and cannot be used.
...
; Related .......: _LOWriter_ImageDelete, _LOWriter_DocGetViewCursor, _LOWriter_DocCreateTextCursor,_LOWriter_CellCreateTextCursor, _LOWriter_FrameCreateTextCursor, _LOWriter_DocHeaderGetTextCursor,
;					_LOWriter_DocFooterGetTextCursor, _LOWriter_EndnoteGetTextCursor, _LOWriter_FootnoteGetTextCursor, _LOWriter_FrameCreateTextCursor
; Link ..........:
; Example .......: Yes
; ===============================================================================================================================
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by previous _LOWriter_DocOpen, _LOWriter_DocConnect, or _LOWriter_DocCreate function.
;                  $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $sName               - [optional] a string value. Default is Null. Name for the Image.
...
;				   @Error 1 @Extended 2 Return 0 = $oImage not an Object.
;				   @Error 1 @Extended 3 Return 0 = $sName not a String.
;				   @Error 1 @Extended 4 Return 0 = Document already contains Image with same name as $sName.
...
;                  $iColor              - [optional] an integer value (0-16777215). Default is Null. The Color of the Image shadow, set in Long Integer format, can be a custom value, or one of the constants, $LOW_COLOR_* as defined in LibreOfficeWriter_Constants.au3.
;                  $bTransparent        - [optional] a boolean value. Default is Null. Whether the Image Shadow is transparent or not.
...
;				   --Initialization Errors--
;				   @Error 2 @Extended 1 Return 0 = Failed to retrieve the image Actual Size structure.
;				   @Error 2 @Extended 2 Return 0 = Failed to retrieve the image Size structure.
;				   @Error 2 @Extended 3 Return 0 = Failed to retrieve the image Size structure again after setting scale sizing.
;				   --Property Setting Errors--
;				   @Error 4 @Extended ? Return 0 = Some settings were not successfully set. Use BitAND to test @Extended for following values:
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iTransparency       - [optional] an integer value (0-100). Default is Null. The percentage of transparency. 0% = Fully visible, 100% = completely transparent.
...
;                  $iRelativeWidth      - [optional] an integer value. Default is Null. Calculates the width of the Image as a percentage of the width of the page text area. Min. 0 (off). Max 254.
...
;                  $bAutoWidth          - [optional] a boolean value. Default is Null. Automatically adjusts the width of a Image. $iWidth becomes the minimum width the Image must be.
;                  $iHeight             - [optional] an integer value. Default is Null. The height that you want for the Image, in Micrometers(uM). Min. 51.
;                  $iRelativeHeight     - [optional] an integer value. Default is Null. Calculates the Height of the Image as a percentage of the Height of the page text area. Min. 0 (off). Max 254.
...
;                  $bAutoHeight         - [optional] a boolean value. Default is Null. Automatically adjusts the height of a Image. $iHeight becomes the minimum height the Image must be.
...
; Parameters ....: $oImage           - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iWrapType           - [optional] an integer value (0-5). Default is Null. The way you want text to wrap around the Image. See Constants, $LOW_WRAP_MODE_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iLeft               - [optional] an integer value. Default is Null. The amount of space that you want between the left edge of the Image and the text. Set in Micrometers.
;                  $iRight              - [optional] an integer value. Default is Null. The amount of space that you want between the Right edge of the Image and the text. Set in Micrometers.
;                  $iTop                - [optional] an integer value. Default is Null. The amount of space that you want between the Top edge of the Image and the text. Set in Micrometers.
;                  $iBottom             - [optional] an integer value. Default is Null. The amount of space that you want between the Bottom edge of the Image and the text. Set in Micrometers.
; Return values .: Success: 1 or Array
;				   Failure: 0 and sets the @Error and @Extended flags to non-zero.
;				   --Input Errors--
;				   @Error 1 @Extended 1 Return 0 = $oImage not an Object.
...
;					Call any optional parameter with Null keyword to skip it.
; Related .......:  _LOWriter_ImageInsert, _LOWriter_ImageGetObjByName, _LOWriter_ConvertFromMicrometer,
;					_LOWriter_ConvertToMicrometer, _LOWriter_ImageWrapOptions
; Link ..........:
; Example .......: Yes
; ===============================================================================================================================
