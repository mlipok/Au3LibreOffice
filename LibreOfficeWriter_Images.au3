...
Func _LOWriter_ImageAreaColor(ByRef $oImage, $iBackColor = Null, $bBackTransparent = Null)
	...
	If __LO_VarsAreNull($iBackColor, $bBackTransparent) Then
		__LO_ArrayFill($avColor, __LOWriter_ColorRemoveAlpha($oImage.BackColor()), $oImage.BackTransparent())
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iTop                - [optional] an integer value (0-16777215). Default is Null. Set the Top Border Line Color of the Image in Long Color code format. Can be a custom value, or one of the constants, $LO_COLOR_* as defined in LibreOffice_Constants.au3.
;                  $iBottom             - [optional] an integer value (0-16777215). Default is Null. Set the Bottom Border Line Color of the Image in Long Color code format. Can be a custom value, or one of the constants, $LO_COLOR_* as defined in LibreOffice_Constants.au3.
;                  $iLeft               - [optional] an integer value (0-16777215). Default is Null. Set the Left Border Line Color of the Image in Long Color code format. Can be a custom value, or one of the constants, $LO_COLOR_* as defined in LibreOffice_Constants.au3.
;                  $iRight              - [optional] an integer value (0-16777215). Default is Null. Set the Right Border Line Color of the Image in Long Color code format. Can be a custom value, or one of the constants, $LO_COLOR_* as defined in LibreOffice_Constants.au3.
; Return values .: Success: 1 or Array.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oImage not an Object.
...
;                  $iTop                - [optional] an integer value. Default is Null. Set the Top Distance between the Border and Image in Hundredths of a Millimeter (100th MM).
;                  $iBottom             - [optional] an integer value. Default is Null. Set the Bottom Distance between the Border and Image in Hundredths of a Millimeter (100th MM).
;                  $iLeft               - [optional] an integer value. Default is Null. Set the Left Distance between the Border and Image in Hundredths of a Millimeter (100th MM).
;                  $iRight              - [optional] an integer value. Default is Null. Set the Right Distance between the Border and Image in Hundredths of a Millimeter (100th MM).
; Return values .: Success: 1 or Array.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oImage not an Object.
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iTop                - [optional] an integer value. Default is Null. Set the Top Border Line width of the Image in Hundredths of a Millimeter (100th MM). Can be a custom value, or one of the constants, $LOW_BORDERWIDTH_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iBottom             - [optional] an integer value. Default is Null. Set the Bottom Border Line Width of the Image in Hundredths of a Millimeter (100th MM). Can be a custom value, or one of the constants, $LOW_BORDERWIDTH_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iLeft               - [optional] an integer value. Default is Null. Set the Left Border Line width of the Image in Hundredths of a Millimeter (100th MM). Can be a custom value, or one of the constants, $LOW_BORDERWIDTH_* as defined in LibreOfficeWriter_Constants.au3.
;                  $iRight              - [optional] an integer value. Default is Null. Set the Right Border Line Width of the Image in Hundredths of a Millimeter (100th MM). Can be a custom value, or one of the constants, $LOW_BORDERWIDTH_* as defined in LibreOfficeWriter_Constants.au3.
; Return values .: Success: 1 or Array.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oImage not an Object.
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iLeft               - [optional] an integer value. Default is Null. The amount in Hundredths of a Millimeter (100th MM) to either extend the background of the image, (negative numbers), or to crop, (positive numbers) from the Left side.
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iWidth              - [optional] an integer value. Default is Null. The Width of the Image Shadow set in Hundredths of a Millimeter (100th MM).
;                  $iColor              - [optional] an integer value (-1-16777215). Default is Null. The Color of the Image shadow, set in Long Integer format, can be a custom value, or one of the constants, $LO_COLOR_* as defined in LibreOffice_Constants.au3.
...
;                  $iWidth              - [optional] an integer value. Default is Null. The Width of the image, set in Hundredths of a Millimeter (100th MM).
;                  $iHeight             - [optional] an integer value. Default is Null. The Height of the image, set in Hundredths of a Millimeter (100th MM).
...
;                  $iHorPos             - [optional] an integer value. Default is Null. The horizontal position of the Image. set in Hundredths of a Millimeter (100th MM). Only valid if $iHorAlign is set to $LOW_ORIENT_HORI_NONE().
...
;                  $iVertPos            - [optional] an integer value. Default is Null. The vertical position of the Image. set in Hundredths of a Millimeter (100th MM). Only valid if $iVertAlign is set to $LOW_ORIENT_VERT_NONE().
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOWriter_DocOpen, _LOWriter_DocConnect, or _LOWriter_DocCreate function.
;                  $oImage              - [in/out] an object. A Image object returned by a previous _LOWriter_ImageInsert, or _LOWriter_ImageGetObjByName function.
;                  $iWidth              - [optional] an integer value. Default is Null. The width of the Image, in Hundredths of a Millimeter (100th MM). Min. 51.
...
;                  $iHeight             - [optional] an integer value. Default is Null. The height of the Image, in Hundredths of a Millimeter (100th MM). Min. 51.
...
;                  $iLeft               - [optional] an integer value. Default is Null. The amount of space between the left edge of the Image and the text. Set in Hundredths of a Millimeter (100th MM).
;                  $iRight              - [optional] an integer value. Default is Null. The amount of space between the Right edge of the Image and the text. Set in Hundredths of a Millimeter (100th MM).
;                  $iTop                - [optional] an integer value. Default is Null. The amount of space between the Top edge of the Image and the text. Set in Hundredths of a Millimeter (100th MM).
;                  $iBottom             - [optional] an integer value. Default is Null. The amount of space between the Bottom edge of the Image and the text. Set in Hundredths of a Millimeter (100th MM).
; Return values .: Success: 1 or Array
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oImage not an Object.
