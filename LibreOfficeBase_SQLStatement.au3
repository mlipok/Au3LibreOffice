...
;                  $iSetType            - [optional] an integer value. Default is Null. The type of Set command to perform. See Constants, $LOB_DATA_SET_TYPE_* as defined in LibreOfficeBase_Constants.au3.
